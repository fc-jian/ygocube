...
export class AdminController {
  ...
  updateTournamentConfig(@Req() req: AuthedRequest, @Body() body: Record<string, unknown>) {
    ...
    for (const key of ['name', 'maxPlayers', 'mode', 'packSizeMultiple', 'cardPool', 'mainMin', 'mainMax', 'extraMax', 'sideMax', 'maxCopies', 'timeLimit', 'pickSeconds', 'deckbuildingSeconds', 'dropMode', 'packStrategy']) {
